...
class TestReviewComment:
    ...
    def test_review_comment_basic(self):
        ...
        comment = ReviewComment(id=123, body="This needs to be fixed")
    ...
    def test_review_comment_with_location(self):
        ...
        comment = ReviewComment(
            id=456, body="Fix this line", path="src/main.py", line=42, start_line=40, side="LEFT"
        )
...
class TestGitHubPRReview:
    ...
    def test_github_pr_review_basic(self):
        ...
        review = GitHubPRReview(id=123, state="APPROVED", body="Looks good to me!")
    ...
    def test_github_pr_review_with_comments(self):
        ...
        review = GitHubPRReview(
            id=789, state="COMMENTED", body="General review", comments=[comment1, comment2]
        )
...
class TestReviewModel:
    ...
    def test_review_basic(self):
        ...
        review = Review(type=ReviewType.AI, status=ReviewStatus.COMPLETED)
    ...
    def test_review_with_github_review(self):
        ...
        github_review = GitHubPRReview(id=123, state="APPROVED", body="LGTM", author="reviewer1")
    ...
    def test_review_metadata(self):
        ...
        metadata = {"pr_number": 42, "iteration": 2, "ai_agent": "pull-request-reviewer"}

        review = Review(type=ReviewType.AI, status=ReviewStatus.COMMENTS_POSTED, metadata=metadata)
...
class TestWorkflowsConfigValidation:
    ...
    def test_review_check_interval_validation(self):
        ...
        with pytest.raises(
            ValidationError, match="Review check interval must be at least 1 second"
        ):
            WorkflowsConfig(review_check_interval=0)
    ...
    def test_workflows_config_template_validation(self):
        ...
        config = WorkflowsConfig(
            branch_naming="feature/{id}", implementation_commit_message="feat({id}): {title}"
        )
...
class TestReviewModelsIntegration:
    ...
    def test_review_with_full_github_data(self):
        ...
        comment1 = ReviewComment(
            id=1, body="Please fix the formatting", path="src/main.py", line=25, author="reviewer1"
        )

        comment2 = ReviewComment(
            id=2, body="Add error handling here", path="src/utils.py", line=10, author="reviewer1"
        )
        ...
        review = Review(
            ...
            github_review=github_review,
            metadata={"pr_number": 42, "review_iteration": 1},
        )
