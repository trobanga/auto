...
from auto.config import ConfigManager, ConfigError, get_config
from auto.models import Config, WorkflowConfig, AIConfig
...
class TestReviewConfigurationValidation:
    ...
    def test_ai_review_configuration_validation(self):
        ...
        # Test empty agents (should use defaults)
        ai_config_with_defaults = AIConfig(
            command="claude",
            review_agent="",  # Empty should use default
            update_agent=""   # Empty should use default
        )
        # The actual validation depends on your AIConfig implementation
        # This test assumes defaults are applied when empty strings are provided
    ...
    def test_configuration_with_custom_review_settings(self):
        ...
        custom_config_data = {
            "workflows": {
                ...
                "branch_naming": "review/{issue_type}/{issue_id}",
