...
class ConfigManager:
    ...
    def _expand_env_vars(self, data: Any) -> Any:
        ...
        if isinstance(data, str):
            ...
            def replace_env_var(match: Match[str]) -> str:
                ...
                if ":-" in var_expr:
                    ...
                    if var_value is None:
                        ...
                        return cast(str, match.group(0))  # Return original if not found
                    return var_value
            ...
            def replace_simple_var(match: Match[str]) -> str:
    ...
    def get_config_value(self, key: str) -> Any:
        ...
        try:
            ...
            raise ConfigError(f"Configuration key not found: {key}") from e
    ...
    def set_config_value(self, key: str, value: Any, user_level: bool = True) -> None:
        ...
        config_path: Path | None = (
            self._user_config_path if user_level else self._project_config_path
        )
        ...
        if config_path is None:
            raise ConfigError("No configuration path available")
    ...
    def create_default_config(self, user_level: bool = True) -> Path:
        ...
        """
        config_path: Path | None = self._user_config_path if user_level else None
        ...
        try:
            ...
            raise ConfigError(f"Failed to create configuration file {config_path}: {e}") from e

    def list_config_files(self) -> dict[str, Path | None]:
